/**
 * Portable SHA-256 hex digest (UTF-8 input).
 * Works in Node, Metro/RN, and browsers — no node:crypto.
 */
...
/** SHA-256 of a UTF-8 string, lowercase hex (same as node:crypto createHash('sha256').digest('hex')). */
